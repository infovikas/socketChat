...
var ChatRoomPage = /** @class */ (function () {
    function ChatRoomPage(navCtrl, navParams, socket, toastCtrl) {
        ...
        // this.getOldMessages().subscribe(message => {
